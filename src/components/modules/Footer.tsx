...
function Footer() {
  return (
    <footer className="pt-10 pb-3 bg-custom-dark-blue rounded-t-2xl shadow-center max-lg:text-sm max-sm:text-[12px]">
        <div className="container mx-auto">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-y-3">
                <div className="flex flex-col items-start">
                    ...
                    <ul>
                        <li><a href="#">تعیین سطح</a></li>
                        <li><a href="#">دوره ها</a></li>
                        <li><a href="#">کتاب های آموزشی</a></li>
                ...
                <div className="flex flex-col items-start">
                    ...
                    <ul>
                        <li><a href="#">American English file</a></li>
                        <li><a href="#">Top Notcht</a></li>
                        <li><a href="#">Family and Friends</a></li>
                        <li><a href="#">508 words</a></li>
                        <li><a href="#">Viewpoint</a></li>
                        <li><a href="#">Consept and commands</a></li>
                    </ul>
                </div>

                <div className="flex flex-col items-start">
                    <h6 className="pb-2 mb-2 font-bold text-custom-blue border-b-2 border-custom-blue border-solid">دوره های مدرسه</h6>
                    <ul>
                        <li><a href="#">پایه هفتم</a></li>
                        <li><a href="#">پایه هشتم</a></li>
                        <li><a href="#">پایه نهم</a></li>
                        <li><a href="#">پایه دهم</a></li>
                        <li><a href="#">پایه یازدهم</a></li>
                        <li><a href="#">پایه دوازدهم</a></li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col items-start">
                    ...
                    <dl className="text-[#eee]">
                        <dt>شماره تماس :</dt>
                        <dd className="sm:mr-5 sm:text-end">0938264691</dd>
                        <dt>ایمیل :</dt>
                        <dd className="sm:mr-5 sm:text-end">classzaban@gmail.com</dd>
                    </dl>
