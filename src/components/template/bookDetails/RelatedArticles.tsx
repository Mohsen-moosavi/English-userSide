...
import { getRelatedArticlesService } from '@/services/singleBookService'
import { RelatedArticleType } from '@/utils/types'
import React from 'react'

async function RelatedArticles() {
    const { responseData: articles, error }: { responseData?: RelatedArticleType[], error?: any } = await getRelatedArticlesService()
