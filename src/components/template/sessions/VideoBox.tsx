    ...
    return (
      <div className="grid lg:grid-cols-7 gap-x-3 gap-y-3 mb-5">
        <div className='lg:col-span-5'>
          <section className="sm:p-3 p-2 rounded-xl shadow-center">
            ...
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-custom-dark-blue font-bold sm:text-xl text-md">{sessionDetails?.name}</h1>
            </div>
            <video controls src={sessionDetails?.video} className="w-full bg-black rounded-xl"></video>
