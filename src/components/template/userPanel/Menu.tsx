...
function Menu() {
    ...
    return (
        <ul className='flex md:flex-col max-md:flex-row-reverse pt-2 w-max font-bold text-custom-dark-blue'>
            <li className={`px-2 py-2 hover:bg-[#B9DCE6]/70 rounded-full md:rounded-xl ${(pathName==='/user-panel' || pathName==='/user-panel/edit') ? '!bg-[#50dcf5]' :''}`}>
                <Link href={'/user-panel'} className="block w-full !text-[#166d91] !hover:text-[#166d91] max-lg:text-sm">
            ...
            <li className={`px-2 py-2 hover:bg-[#B9DCE6]/70 rounded-full md:rounded-xl ${pathName==='/user-panel/courses' ? '!bg-[#50dcf5]' :''}`}>
                <Link href={'/user-panel/courses'} className="block w-full !text-[#166d91] !hover:text-[#166d91] max-lg:text-sm">
            ...
            <li className={`px-2 py-2 hover:bg-[#B9DCE6]/70 rounded-full md:rounded-xl ${(pathName==='/user-panel/tickets' || pathName==='/user-panel/tickets/create' || (/^\/user-panel\/tickets\/\d+$/).test(pathName)) ? '!bg-[#50dcf5]' :''}`}>
                <Link href={'/user-panel/tickets'} className="block w-full !text-[#166d91] !hover:text-[#166d91] max-lg:text-sm">
            ...
            <li className={`px-2 py-2 hover:bg-[#B9DCE6]/70 rounded-full md:rounded-xl ${pathName==='/user-panel/bag' ? '!bg-[#50dcf5]' :''}`}>
                <Link href={'/user-panel/bag'} className="block w-full !text-[#166d91] !hover:text-[#166d91] max-lg:text-sm">
            ...
            <li className='px-2 py-2 hover:bg-[#B9DCE6]/70 rounded-full md:rounded-xl'>
                <Link href={'/'} className="block w-full !text-[#166d91] !hover:text-[#166d91] max-lg:text-sm">
            ...
            <li className='px-2 py-2 hover:bg-[#B9DCE6]/70 rounded-full md:rounded-xl '>
                <button className="block w-full text-start !text-[#166d91] !hover:text-[#166d91] max-lg:text-sm" onClick={logoutHandler}>
