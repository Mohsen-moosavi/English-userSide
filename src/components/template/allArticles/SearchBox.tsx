...
import { changePaginatorChangerFlag, setSearchword } from '@/redux/slice/allArticles/allArticlesSlice'
import React from 'react'

function SearchBox() {
    const { searchWord, loaded } = useAppSelector(state => state.allArticle)
