...
function ArticleList() {
    ...
    return (
        <div className="container mx-auto">
            ...
            <Pagination itemsCount={articlesCount} numberOfitemInEveryPage={limit} defaultPage={1} paginationHandler={paginationHandler} setOffset={setOffset} reseter={paginatorChangerFlag} />
        </div>
    )
}
