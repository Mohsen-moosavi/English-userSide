...
function ResetPasswordForm() {
    ...
    return (
        <form className="w-full my-3 p-2 sm:p-4 flex flex-col items-center justify-start gap-y-4 mt-8 sm:mt-12" onSubmit={formik.handleSubmit}>
            ...
            <button type='submit' disabled={sending} className={`rounded-full py-2 px-4 border-4 border-solid border-[#0000a3] bg-[#d2eeff] text-[#0000a3] transition-all hover:bg-[#70baff] ${sending ? 'opacity-60' : ''}`}>ویرایش</button>
        </form>
    )
}
