...
import { changePaginatorChangerFlag, setSearchword } from '@/redux/slice/allCourses/allCourseSlice'
import React from 'react'

function SearchBox() {
    const { searchWord, loaded } = useAppSelector(state => state.allCourse)
