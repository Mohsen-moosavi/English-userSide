...
function CourseList() {
    ...
    return (
        <div className="container mx-auto">
            ...
            <Pagination itemsCount={coursesCount} numberOfitemInEveryPage={limit} defaultPage={1} paginationHandler={paginationHandler} setOffset={setOffset} reseter={paginatorChangerFlag} />
        </div>
    )
}
