                                                ...
                                                <div className="p-3 border-solid border-custom-dark-blue border-2 mt-2 rounded-xl">
                                                    {course?.sessions.map((session, index) => (
                                                        <div className={`py-2 ${index === 0 ? '' : 'border-t border-solid border-custom-dark-blue'}`} key={index}>
                                                            {session.isFree ? (
                                                                <Link href={`/courses/${slug}/${session.id}`} className="flex items-center gap-x-1 sm:gap-x-3 text-custom-dark-blue max-sm:text-[12px] hover:bg-sky-400/10">
                                                    ...
                                                    <SessionList courseId={course?.id || 0} courseSlug={slug} sessionCount={course?.sessionCount || 0} />
                                                </div>
                                            ) : (
